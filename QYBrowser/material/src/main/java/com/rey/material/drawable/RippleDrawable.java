        ...
        switch (event.getAction()) {
            ...
            case MotionEvent.ACTION_MOVE:
                if (mState == STATE_OUT || mState == STATE_RELEASE) {
                    ...
                    setRippleEffect(v.getLeft() + v.getWidth() / 2, v.getHeight() / 2, 0);
...
//						invalidateSelf();
    ...
    private void updateTouch() {
        if (mState != STATE_RELEASE) {
            ...
            setRippleEffect(mRipplePoint.x, mRipplePoint.y, mMaxRippleRadius * (1f + 0.8f * mOutInterpolator.getInterpolation(touchProgress)));
