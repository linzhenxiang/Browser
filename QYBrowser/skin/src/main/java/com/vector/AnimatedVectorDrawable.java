...
public class AnimatedVectorDrawable extends DrawableCompat implements Animatable, Tintable {
    ...
    private static final String ANIMATED_VECTOR = "animated-com.cube.vector";
    ...
    @Override
    public void setCurrentLayoutDirection(int layoutDirection) {
    ...
    public void start(AnimatorListenerAdapter listenerAdapter) {
        final ArrayList<Animator> animators = mAnimatedVectorState.mAnimators;
