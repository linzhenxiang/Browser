...
public class VectorDrawable extends DrawableCompat implements Tintable {
    ...
    public static VectorDrawable create(Resources resources, int rid) {
        try {
            ...
            Log.e("VV", "_____TAG:" + "parser error");
            Log.e(LOGTAG, "parser error", e);
        } catch (IOException e) {
            Log.e("VV", "_____TAG:" + "IOException error");
    ...
    public VectorDrawableState getVectorState() {
        return mVectorState;
    }
    ...
    public static class VectorDrawableState extends ConstantStateCompat {
        int[] mThemeAttrs;
